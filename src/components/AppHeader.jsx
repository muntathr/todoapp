...
function AppHeader() {
  ...
  return (
    <div className={styles.appHeader}>
      ...
      <h1>TODO</h1>
      <Button variant="primary" onClick={() => updateFilter("all")} status={filterStatus == 'all' && 'active'}>
      ...
      <Button variant="primary" onClick={() => updateFilter("incomplete")} status={filterStatus == 'incomplete' && 'active'}>
      ...
      <Button variant="primary" onClick={() => updateFilter("complete")} status={filterStatus == 'complete' && 'active'}>
